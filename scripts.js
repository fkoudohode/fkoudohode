...
const publications = [
  ...
  },
  {
    ...
    status: "published",
    year: 2025,
    title: "Switched predictor feedbacks for PDE and ODE systems subject to state and input quantization",
    authors: "F. Koudohode, N. Bekiaris-Liberis",
  ...
  },
  {
    ...
    arxiv: "2404.11194",
    hal: null,
    pdf: "assets/papers/scl2024-quantization-delay.pdf",
    code: null,
    abstract: null,
    toConfirm: false,
  },
  {
    ...
    arxiv: null,
    hal: null,
    pdf: "assets/papers/scl2024-event-triggered-reaction-diffusion.pdf",
    code: null,
    abstract: null,
    toConfirm: false,
  },
  {
    ...
    arxiv: null,
    hal: null,
    pdf: "assets/papers/automatica2022-wave.pdf",
    code: null,
    abstract: null,
    toConfirm: false,
  },
  ...
  },
  {
    ...
    arxiv: null,
    hal: null,
    pdf: "assets/papers/preprint2025-reaction-diffusion-quantization.pdf",
    code: null,
    abstract: null,
    url: "https://api.semanticscholar.org/CorpusID:275920743",
    toConfirm: false,
  },
  {
    id: "C3",
    ...
    authors: "F. Koudohode, N. Bekiaris-Liberis",
    venue: "IEEE Conference on Decision and Control, Milan, Italy",
    venueDetail: "",
  ...
  },
  {
    ...
    venueDetail: "pp. 2099–2104",
    doi: "10.23919/ECC55457.2022.9837965",
    arxiv: null,
    hal: null,
    pdf: "assets/papers/ecc2022-schrodinger.pdf",
    code: null,
    abstract: null,
    toConfirm: false,
  },
...

  {
    ...
    arxiv: null,
    hal: "tel-04279601v3",
    pdf: "assets/docs/thesis-koudohode-2023.pdf",
    code: null,
    abstract: null,
    toConfirm: false,
  },
...
const translations = {
  en: {
    ...
    hero_formula_label:     "Event-triggering condition",
    ...
    // ── About page ───────────────────────────────
    about_banner_eyebrow: "About",
    about_banner_title:   "From Cotonou to Chania.",
    about_banner_lead:    "A short walk through my path — and the longer answer if you want to keep reading.",

    about_who_title:      "Who I am",
    about_who_p1:         "My name is Florent Koudohode. I grew up in Benin, where a single course in differential equations at the Institut de Mathématiques et de Sciences Physiques (IMSP) made me suspect that there was a hidden language behind every physical phenomenon I had ever noticed — and that I wanted to learn it.",
    about_who_p2:         "That suspicion eventually carried me to Toulouse, where I completed a Master and a PhD at LAAS-CNRS under the guidance of Lucie Baudouin and Sophie Tarbouriech, working on event-based control of partial differential equations. Today I am a postdoctoral researcher at the Technical University of Crete, supported by the European Research Council on the C-NORA project, where I think about how to stabilise infinite-dimensional systems when the world insists on being delayed, quantized and noisy.",
    about_who_p3:         "What I love most about this work is that it sits exactly at the seam between pure mathematics and the messy reality of engineering — Lyapunov functionals on one side, sensors and actuators on the other, and a real chance to make both speak to each other. Outside the lab, you'll find me playing amateur rugby with the Cretan Gunners or trying — with mixed success — to learn Greek.",

    about_bio_title:    "Short biography",
    about_bio_meta:     "For invitations, talks, journal headers",
    about_bio_text:     "Florent Koudohode is a Postdoctoral Researcher in the Department of Electrical and Computer Engineering at the Technical University of Crete, Greece, supported by the European Research Council under the 2022 Consolidator Grant C-NORA (#101088147). His research focuses on the analysis and control of infinite-dimensional systems governed by partial differential equations, with particular emphasis on event-triggered boundary control, predictor feedback for delayed systems, and state and input quantization. He received his Ph.D. in Automatic Control from Université Paul Sabatier — Toulouse III (LAAS-CNRS) in 2023, under the supervision of Lucie Baudouin and Sophie Tarbouriech. His work has been published in leading journals including Automatica, Systems & Control Letters and IEEE Transactions on Automatic Control, and he collaborates with researchers such as Miroslav Krstic (UC San Diego) and Nicolás Espitia (CNRS, Université de Lille).",
  ...
  fr: {
    ...
    // ── About page ───────────────────────────────
    about_banner_eyebrow: "À propos",
    about_banner_title:   "De Cotonou à La Canée.",
    about_banner_lead:    "Une brève traversée de mon parcours — et la version longue si vous voulez continuer à lire.",

    about_who_title:      "Qui je suis",
    about_who_p1:         "Je m'appelle Florent Koudohode. J'ai grandi au Bénin, où un seul cours sur les équations différentielles à l'Institut de Mathématiques et de Sciences Physiques (IMSP) m'a fait soupçonner qu'il y avait un langage caché derrière chaque phénomène physique que j'avais jamais observé — et que je voulais l'apprendre.",
    about_who_p2:         "Ce soupçon m'a conduit à Toulouse, où j'ai obtenu un Master puis un doctorat au LAAS-CNRS sous la direction de Lucie Baudouin et Sophie Tarbouriech, sur la commande à événements des équations aux dérivées partielles. Je suis aujourd'hui chercheur postdoctoral à l'Université Technique de Crète, financé par le Conseil Européen de la Recherche sur le projet C-NORA, où je m'attache à stabiliser des systèmes infinis-dimensionnels dans un monde obstinément retardé, quantifié et bruité.",
    about_who_p3:         "Ce qui me plaît le plus dans ce travail, c'est qu'il se tient exactement sur la couture entre les mathématiques pures et la réalité brute de l'ingénieur — fonctionnelles de Lyapunov d'un côté, capteurs et actionneurs de l'autre, et une vraie chance de les faire dialoguer. Hors du laboratoire, vous pourriez me croiser en train de jouer au rugby amateur avec les Cretan Gunners, ou d'apprendre — avec un succès mitigé — le grec.",

    about_bio_title:    "Biographie courte",
    about_bio_meta:     "Pour invitations, exposés, en-têtes de journal",
    about_bio_text:     "Florent Koudohode est chercheur postdoctoral au Département de Génie Électrique et Informatique de l'Université Technique de Crète, en Grèce, soutenu par le Conseil Européen de la Recherche dans le cadre du Consolidator Grant C-NORA 2022 (#101088147). Ses recherches portent sur l'analyse et la commande de systèmes infinis-dimensionnels gouvernés par des équations aux dérivées partielles, avec un intérêt particulier pour la commande aux bords à événements, le feedback prédicteur pour systèmes à retards, et la quantification d'état et d'entrée. Il a obtenu son doctorat en Automatique à l'Université Paul Sabatier — Toulouse III (LAAS-CNRS) en 2023, sous la direction de Lucie Baudouin et Sophie Tarbouriech. Ses travaux ont été publiés dans des revues internationales de référence — Automatica, Systems & Control Letters, IEEE Transactions on Automatic Control — et il collabore avec des chercheurs tels que Miroslav Krstic (UC San Diego) et Nicolás Espitia (CNRS, Université de Lille).",
...
function renderPublicationCard(pub) {
  ...
  if (pub.code) {
    ...
    actions.push(`<a class="pub-link" href="${escapeHtml(href)}" target="_blank" rel="noopener">
  ...
  return `
  <article class="pub-card" data-type="${pub.type}" data-year="${pub.year}">
